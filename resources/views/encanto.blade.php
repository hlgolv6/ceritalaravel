...
<html lang="en">
  <head>
    ...
    <!-- my CSS -->
    <link rel="stylesheet" href="assets/css/styleencanto.css">
  ...
  <body id="halaman 1">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav d-flex flex-column fs-3">
              <li class="navbar-brand">
                <a class="nav-link mb-5 text-white fw-bold fs-1" href="/home">Disney</a>
              </li>
              <li class="nav-item">
                <a class="nav-link ms-2" href="/moana">Cerita 1</a>
              </li>
              <li class="nav-item">
                <a class="nav-link ms-2" href="/rapunzel">Cerita 2</a>
              </li>
              <li class="nav-item" >
                <a class="nav-link ms-2 active" aria-current="page" href="#">Cerita 3</a>
              </li>
              <li class="nav-item ">
                <a class="nav-link ms-2" href="/frozen">Cerita 4</a>
              </li>
            </ul>
          </div>
        </div>
    ...
    <section class="judul">
        <div class="encanto col-mt 5">
            ...
            <img src="/assets/img/encanto/encanto1.jpg" width="270">
        </div>
    </section>
    <!--end Judul&gambar-->
    </center>
