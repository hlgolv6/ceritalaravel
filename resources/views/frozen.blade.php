...
<html lang="en">
  <head>
    ...
    <!-- my CSS -->
    <link rel="stylesheet" href="assets/css/stylefrozen.css">
  ...
  <body id="halaman 1">
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav d-flex flex-column fs-4">
              ...
              <li class="nav-item">
                <a class="nav-link" href="/moana">Cerita 1</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="/rapunzel">Cerita 2</a>
              </li>
              <li class="nav-item" >
                <a class="nav-link"  href="/encanto">Cerita 3</a>
              </li>
              <li class="nav-item">
    ...
    <section class="judul">
        <div class="frozen col-mt 5">
            ...
            <img src="assets/img/frozen/frozen1.jpg" width="270">
        </div>
    </section>
    <!--end Judul&gambar-->
    </center>
