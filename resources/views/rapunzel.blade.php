...
<html lang="en">
  <head>
    ...
    <!-- my CSS -->
    <link rel="stylesheet" href="assets/css/stylerapunzel.css">
  ...
  <body id="halaman 1">
    ...
    style="background: linear-gradient(0deg, rgb(15, 104, 60) 5%, rgb(72, 170, 124) 50%);">
        <div class="container">
          <a class="navbar-brand fw-bold fs-1" href="/home">Disney</a>
          ...
          <div class="collapse navbar-collapse " id="navbarNav">
            <ul class="navbar-nav ms-auto fs-3">
              ...
              <li class="nav-item">
                <a class="nav-link" href="/frozen">cerita 4</a>
              </li>
    ...
    <section class="judul">
        <div class="rapunzel col-mt 5">
            ...
            <img src="assets/img/rapunzel/rapunzel1.jpg" width="270">
        </div>
    </section>
    <!--end Judul&gambar-->
